import type { CoreTaskAttributesAssessments } from "./core_task_attributes_assessments.js";

export interface CoreTaskAttributes {
  authorId: number;
  name: string;
  dueDate: string;
  ...
  phase?: number;
  assessments?: CoreTaskAttributesAssessments;
}
